$(function () {
  ...
  function result() {
    if (cmds[current].callback != undefined) {
      ...
      return;
    } else if (cmds[current].result != undefined) content.find("#result").append(cmds[current].result);
    current++;
    main();
  }
  ...
  function main() {
    $(".console").append(
      "<div class='command-" + current + "'>" + $(".vanilla").html() + "</div>"
    );
    ...
    if (cmds[current] != undefined) {
      if (cmds[current].pwd != undefined) pwd = cmds[current].pwd;
  ...
  function re_vim() {
    ...
    $(".vim .cmd").typed({
      ...
      callback: function () {
        $(".vim .menu").html(
          '<span style="color: green"> 1</span>+ index.html'
        );
    ...
    $(".vim #content").typed({
      ...
      callback: function () {
        ...
        $(".vim .infos").animate({ right: "30%" }, 1000, function () {
          ...
          $(".preview").html(o_html);
          $(".vim .file").append(
            '<span id="content2" style="white-space:pre"></span>'
          );
          $(".typed-cursor").remove();
          $(".vim #content2").typed({
            strings: html2,
  ...
  function done() {
    $(".typed-cursor").remove();
    $(".vim .file").append(
      '<span id="content3" style="white-space:pre"></span>'
    );
    $(".vim #content3").typed({
      strings: css3,
      typeSpeed: 0,
...
var css2 = [
  "/* Not so bad. Let's make a few changes. */\n\nh1 {\n	margin-top: 1%;\n	margin-bottom: 1%;\n	font-size: 3.5em;\n}\n\na {\n	text-decoration: none;\n	color: #ffffff;\n	transition-property: all;\n	transition-duration: 0.3s;\n}\n\na:hover {\n	color: #DC3522;\n}\n\na i {\n	font-size: 2em;\n	margin-right: 1%;\n	margin-left: 1%;\n}\nimg {\n	margin-top: 5%;\n	border-radius: 50%;\n	width: 30vh;\n}",
];
