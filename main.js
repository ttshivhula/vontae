...
var o_html = '<img src="vontae.jpg"/><h1><span class="small-title">Tshilidzi</span> Tshivhula</h1><a href="https://github.com/ttshivhula"><i class="fa fa-git"></i></a><a href="http://twitter.com/pboyfunclub"><i class="fa fa-twitter"></i></a><a href="cv.pdf"><i class="fa fa-file-pdf-o"></i></a><br /><br /><a class="mail" href="mailto:tshilidzi@vontae.co.za"><i class="fa fa-envelope little"></i>tshilidzi@vontae.co.za</a><br />';
